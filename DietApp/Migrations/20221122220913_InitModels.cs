        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FatPer100 = table.Column<double>(type: "float", nullable: false),
                    CarboPer100 = table.Column<double>(type: "float", nullable: false),
                    ProteinPer100 = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalCarbo = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryRecipe", x => new { x.CategoryId, x.RecipesRecipeId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyConsumption_UserId",
